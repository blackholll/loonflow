    ...
    >
      <Row gutter={24}>
        ...
        <Col span={12} key="secondCol">
          ...
          >
            <Input placeholder="The description information will be displayed on the New Ticket page" />
          </Form.Item>
        </Col>
      </Row>
      <Row gutter={24}>
      ...
      <Row gutter={24}>
        <Col span={12} key="firstCol">
          ...
          >
            <Input placeholder="Please fill in the fields to be displayed"/>
          </Form.Item>
        </Col>
        <Col span={12} key="secondCol">
          <Form.Item
      ...
      <Row gutter={24}>
        <Col span={12} key="firstCol">
          <Form.Item
            name="view_persons"
            label= {<span>View authorized person<Tooltip title="The person who is set as the viewing authority can see the list of all work orders of this type in 'Work Order Management'-'Work Order View'"><QuestionCircleOutlined /></Tooltip></span>}
          >
            <Select
              allowClear
              showSearch
        ...
        <Col span={12} key="secondCol">
          ...
          >
            <Select
              ...
              showSearch
              style={{ width: '100%' }}
              placeholder="Please select the department to which viewing permission is granted"
            >
              {deptList.map(d => (
