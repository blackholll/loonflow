...
class NotificationService(BaseService):
    ...
    def get_notification_list(cls, tenant_id, search_value, page, per_page, simple=False):
        ...
        notice_queryset = Notification.objects.filter(query_params)
    ...
    @classmethod
    def add_notification(cls, tenant_id: int, operator_id: int, name: str, description: str, type: str, extra: dict) -> int:
        """
        add notice
        :param tenant_id:
        :param operator_id:
    ...
    @classmethod
    def get_notification_detail(cls, notice_id: int) -> dict:
        """
        get notice detail
        :param notice_id:
        :return:
        """
        try:
            notice_obj = Notification.objects.get(id=notice_id)
    ...
    @classmethod
    def update_notification(cls, notice_id: int, name: str, description: str, type: str, extra: dict):
        """
        update notice
        :param notice_id:
        :param operator_id:
        ...
        :return:
        """
        notice_queryset = Notification.objects.filter(id=notice_id)
    ...
    @classmethod
    def delete_notification(cls, operator_id: int, notice_id:int):
        """
        delete notice
        :param operator_id:
        :param notice_id:
