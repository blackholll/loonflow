...
from apps.workflow.views import WorkflowView, WorkflowInitNodeView, WorkflowVersionsView, WorkflowDetailView, WorkflowTicketCreationFormView, WorkflowTicketCreationActionsView, WorkflowProcessSingleSchemaView, WorkflowVersionDetailView
...
urlpatterns = [
    ...
    path('/<str:workflow_id>/versions/<str:version_id>', WorkflowVersionDetailView.as_view()),
