...
class StateAdmin(LoonModelBaseAdmin):
    search_fields = ('name',)
    list_display = ('name', 'order_id', 'type_id', 'workflow_id', 'sub_workflow_id', 'distribute_type_id', 'is_hidden', ) + LoonModelBaseAdmin.list_display


class TransitionAdmin(LoonModelBaseAdmin):
    search_fields = ('name',)
    list_display = ('name', 'workflow_id', 'transition_type_id', 'source_state_id', 'destination_state_id', 'alert_enable') + LoonModelBaseAdmin.list_display


class CustomFieldAdmin(LoonModelBaseAdmin):
    search_fields = ('workflow_id',)
    list_display = ('workflow_id', 'field_type_id', 'field_key', 'field_name', 'order_id') + LoonModelBaseAdmin.list_display
