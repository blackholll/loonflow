...
from apps.ticket.views import TicketListView, ticketlist, TicketView, TicketTransition, TicketFlowlog, TicketFlowStep, TicketState, TicketsStates, TicketAccept, TicketDeliver
...
urlpatterns = [
    ...
    path('/<int:ticket_id>/addnode', TicketAddnode.as_view()),
